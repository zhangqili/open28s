...
static void homepage_tick(void *page)
{
    ...
    fezui_rolling_number_set(&key1_num, g_key_counts[0]);
    fezui_rolling_number_set(&key2_num, g_key_counts[1]);
    fezui_rolling_number_set(&key3_num, g_key_counts[2]);
    fezui_rolling_number_set(&key4_num, g_key_counts[3]);
